...
export default function DeliverySettings({
  ...
  const [activeMenu, setActiveMenu] = useState("fee");
  ...
  return (
    <article className="settings-card settings-card-half">
      ...
      <div className="settings-submenu" aria-label="Delivery settings menu">
        {deliveryMenus.map((menu) => (
          <button
            key={menu.id}
            type="button"
            className={`settings-submenu-btn ${activeMenu === menu.id ? "active" : ""}`}
